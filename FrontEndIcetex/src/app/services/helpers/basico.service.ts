...
export class BasicoService {
  ...
  public ObtenerListaTiposDocumento(): Observable<GeneralResponse  | null >{
  ...
  public ObtenerListaGenero(): Observable<GeneralResponse   | null >{
  ...
  public ObtenerListaGrupoEtnico(): Observable<GeneralResponse   | null >{
  ...
  public ObtenerListaEstrato(): Observable<GeneralResponse   | null >{
  ...
  public ObtenerListaPais(): Observable<GeneralResponse   | null >{
  ...
  public ObtenerListaDepartamento(): Observable<GeneralResponse   | null >{
  ...
  public ObtenerListaCiudad(idDepartamento: any): Observable<GeneralResponse   | null >{
